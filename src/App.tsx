    ...
    <div className="flex h-screen bg-background theme-transition">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-background p-6">
          <Routes>
            <Route path="/" element={<ProtectedRoute><Navigate to="/departments" replace /></ProtectedRoute>} />
            ...
            {/* <Route path="/goals/company" element={<ProtectedRoute><CompanyGoals /></ProtectedRoute>} /> */}
