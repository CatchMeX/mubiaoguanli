...
// 创建出差申请数据
interface CreateBusinessTripData {
  applicantId: string;
  startDate: string;
  startPeriod: string;
  endDate: string;
...
// 更新出差申请数据
interface UpdateBusinessTripData {
  startDate?: string;
  startPeriod?: string;
  endDate?: string;
  endPeriod?: string;
...
// 创建补卡申请数据
interface CreateCardReplacementData {
  applicantId: string;
  departmentId: string;
  replacementDate: string;
  replacementTime: string;
...
// 更新补卡申请数据
interface UpdateCardReplacementData {
  departmentId?: string;
  replacementDate?: string;
  replacementTime?: string;
  reason?: string;
