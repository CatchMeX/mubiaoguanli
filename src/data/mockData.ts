...
// 团队成员绩效配置数据
export const teamMemberPerformances: TeamMemberPerformance[] = [
  {
    id: '1',
    teamId: '1',
    memberId: '2', // 李四
...
// 公司年度目标 - 扩展多个年度目标
export const companyYearlyGoals: CompanyYearlyGoal[] = [
  {
    id: '1',
    year: 2024,
...
// 团队月度目标 - 大幅扩展数据
export const teamMonthlyGoals: TeamMonthlyGoal[] = [
  // 2024年销售部目标
  {
    id: '1',
...
// 个人月度目标 - 大幅扩展数据
export const personalMonthlyGoals: PersonalMonthlyGoal[] = [
  // 销售部个人目标 - 10月
  {
    id: '1',
...
export const operatingCosts: OperatingCost[] = [
  // 当前分摊费用
  {
    id: '1',
    category: 'sales',
...
// 资产附件数据
export const assetAttachments: AssetAttachment[] = [
  {
    id: '1',
    assetId: '1',
    name: '购买发票.pdf',
...
// 资产处置记录
export const assetDisposals: AssetDisposal[] = [
  {
    id: '1',
    asset: {
      ...assets[0],
...
// 采购订单明细数据
export const procurementOrderItems: ProcurementOrderItem[] = [
  {
    id: '1',
...
// 采购附件数据
export const procurementAttachments: ProcurementAttachment[] = [
  {
    id: '1',
    orderId: '1',
...
// 采购审批记录数据
export const procurementApprovalRecords: ProcurementApprovalRecord[] = [
  {
    id: '1',
    orderId: '1',
...
// 采购入库明细数据
export const procurementReceiptItems: ProcurementReceiptItem[] = [
  {
    id: '1',
    receiptId: '1',
    orderItemId: '1',
...
// 采购入库单数据
export const procurementReceipts: ProcurementReceipt[] = [
  {
    id: '1',
...
// 采购异常处理数据
export const procurementExceptions: ProcurementException[] = [
  {
    id: '1',
    receiptId: '1',
    receiptItemId: '1',
...
// 采购统计数据
export const procurementStatistics: ProcurementStatistics = {
...
// 获取团队成员绩效配置的辅助函数
export const getTeamMemberPerformance = (teamId: string, memberId: string): TeamMemberPerformance | undefined => {
  return teamMemberPerformances.find(p => p.teamId === teamId && p.memberId === memberId && p.isActive);
};

// 更新团队成员绩效配置的辅助函数
export const updateTeamMemberPerformance = (config: TeamMemberPerformance): void => {
